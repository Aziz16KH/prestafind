...
public class ModifierQuestion extends Form {
    ...
    private void addGUIs() {
        ...
        sujetTF.setText(currentQuestion.getSujet());
        descriptionTF.setText(currentQuestion.getDescription());
        dateCreationTF.getPicker().setDate(currentQuestion.getDateCreation());
        if (currentQuestion.getStatus() == 1) {
            statusCB.setSelected(true);
        }
        typeTF.setText(currentQuestion.getType());

        utilisateursPC.getPicker().setSelectedString(String.valueOf(currentQuestion.getUtilisateurs().getId()));
        selectedUtilisateurs = currentQuestion.getUtilisateurs();
